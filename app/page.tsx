...
const links = [
  { label: "Email", href: "mailto:devabhijetpandey@gmail.com", icon: Mail },
...
export default function Home() {
  ...
  return <main>
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation"><a href="#work">The portfolio</a><a href="#about">The atelier</a><a href="#contact">Private enquiries</a></nav>
    ...
    <section className="hero" id="top" aria-labelledby="hero-title">
      <div className="hero-copy" data-reveal>
        ...
        <h1 id="hero-title"><span className="hero-word">Founder.</span><span className="hero-word">Developer.</span><em className="hero-word">Product Builder.</em></h1>
    ...
    <section className="work section" id="work" aria-labelledby="work-title">
      <div className="section-top" data-reveal><p className="eyebrow">01 / The portfolio</p><h2 id="work-title">Objects of intent.<br /><em>Made to endure.</em></h2></div>
    ...
    <section className="lab section" data-reveal><p className="eyebrow">04 / Private study</p><div><h2>Experiments<br /><em>in progress.</em></h2><p>SafePlate AI is an early product exploring ingredient-led food decisions, dog profiles, and safer everyday feeding routines.</p><span className="status-pill">In development</span></div></section>
    <section className="contact section" id="contact" aria-labelledby="contact-title" data-reveal><p className="eyebrow">05 / Private enquiries</p><h2 id="contact-title">Have a problem<br />worth <em>building for?</em></h2><div className="contact-links">{links.map(({ label, href, icon: Icon }) => <a key={label} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noreferrer" : undefined}><Icon size={19} strokeWidth={1.7} /><span>{label}</span></a>)}</div></section>

    <footer><Fireflies className="footer-fireflies" count={42} /><div className="footer-brand"><a className="wordmark" href="#top">ABHIJEET<span>·</span>PANDEY</a><p>Building deliberate digital products from Chennai, India.</p></div><div className="footer-links"><p className="eyebrow">Navigate</p><a href="#work">The portfolio</a><a href="#about">The atelier</a><a href="#contact">Private enquiries</a></div><div className="footer-links"><p className="eyebrow">Elsewhere</p>{links.map(({ label, href, icon: Icon }) => <a key={label} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noreferrer" : undefined}><Icon size={15} strokeWidth={1.7} />{label}</a>)}</div><div className="footer-bottom"><span>© {new Date().getFullYear()} Abhijeet Pandey</span><a href="#top">Back to top</a></div></footer>
  </main>;
}
